...
class RecipesPagingAdapter : PagingDataAdapter<Recipe, RecipesPagingAdapter.ItemViewHolder>(DIFF_CALLBACK) {
    ...
    class ItemViewHolder(private val binding: RecipeItemBinding) : RecyclerView.ViewHolder(binding.root) {
        fun bind(recipe: Recipe?) {
            ...
            binding.tvDetails.text = context.getString(R.string.details_placeholder, recipe?.details?.preparationTime,recipe?.details?.type, recipe?.details?.skillLevel)
